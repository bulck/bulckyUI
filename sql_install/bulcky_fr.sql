...
--
-- Host: localhost
-- Generation Time: Nov 28, 2015 at 04:07 PM
...
-- Database: `bulcky`
--
CREATE DATABASE `bulcky` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bulcky`;
...
INSERT INTO `configuration` (`id`, `COLOR_HUMIDITY_GRAPH`, `COLOR_TEMPERATURE_GRAPH`, `COLOR_WATER_GRAPH`, `COLOR_LEVEL_GRAPH`, `COLOR_PH_GRAPH`, `COLOR_EC_GRAPH`, `COLOR_OD_GRAPH`, `COLOR_ORP_GRAPH`, `NB_PLUGS`, `COST_PRICE`, `COST_PRICE_HP`, `COST_PRICE_HC`, `START_TIME_HC`, `STOP_TIME_HC`, `COST_TYPE`, `ADVANCED_REGUL_OPTIONS`) VALUES (1, 'blue', 'red', 'orange', 'pink', 'brown', 'yellow', 'red', 'blue', 3, 0.1225, 0.1353, 0.0926, '22:30', '06:30', 'standard', 'False');
